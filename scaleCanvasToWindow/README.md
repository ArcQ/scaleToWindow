...
These are the older methods written by kittykatattack remain. To use, they are included in ```scale-to-window-pixi/scale-to-canvas-window```
the following is the original readme that was written for this module before we moved to the newer way to use this lib.
